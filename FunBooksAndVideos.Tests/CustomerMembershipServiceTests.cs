...
namespace FunBooksAndVideos.Tests.Infrastructure.Services;

public class EfCustomerMembershipServiceTests
{
    ...
    public void ActivateMembership_WithPremium_AddsAllRequiredMemberships()
    {
        ...
        var sut = new EfCustomerMembershipService(dbContext);
